...
// ============================================================
//  AI CALL — goes to our Netlify function, key stays hidden
// ============================================================
...
async function getStudyFact() {
  ...
  const allowed = await checkAndIncrementUsage();
  if (!allowed) { showBlocked(o); return; }
  const ans = await callAI('Give me one surprising or interesting fact about learning, memory, the brain, or a school subject. Keep it to 2-3 sentences.', 'You share interesting educational facts. Be specific and genuinely interesting. Plain text only.');
  o.textContent = ans;
}
